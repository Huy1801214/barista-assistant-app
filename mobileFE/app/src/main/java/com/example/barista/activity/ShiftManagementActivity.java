...
public class ShiftManagementActivity extends AppCompatActivity implements OnShiftActionListener {
    ...
    private LocalDate selectedDate = LocalDate.now(); // Lưu ngày hiện tại được chọn
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Tải danh sách ca làm việc cho ngày hôm nay khi mở màn hình
    ...
    private void setupRecyclerView() {
        adapter = new WorkShiftAdapter(this, shiftList, this);
        recyclerViewShifts.setLayoutManager(new LinearLayoutManager(this));
        recyclerViewShifts.setAdapter(adapter);
    }

    private void setupCalendar() {
        updateSelectedDateText(selectedDate); // Cập nhật text cho ngày hiện tại
    ...
    private void loadShiftsForDate(LocalDate date) {
        ...
        // TODO: Dựa vào vai trò người dùng để gọi API getMyShifts hoặc getShiftsForStore
        apiService.getShiftsForStore(authToken, startDateTime, endDateTime).enqueue(new Callback<List<WorkShift>>() {
            @Override
